...
export class apiService {
  ...
  getWorkouts(callback: (data) => void) {
    let url = window.location.protocol + '//' + window.location.host.replace(/(:4200)/, ":3000") + "/workouts";
  ...
  getExcersices(callback: (data) => void) {
    let url = window.location.protocol + '//' + window.location.host.replace(/(:4200)/, ":3000") + "/excersices";
  ...
  updateWorkout(id, workout, callback: (data) => void) {
    let url = window.location.protocol + '//' + window.location.host.replace(/(:4200)/, ":3000") + "/workout/" + id;
  ...
  updateExcersice(id, excersice, callback: (data) => void) {
    let url = window.location.protocol + '//' + window.location.host.replace(/(:4200)/, ":3000") + "/excersice/" + id;
